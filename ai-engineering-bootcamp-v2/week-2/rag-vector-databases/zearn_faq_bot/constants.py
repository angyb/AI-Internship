...
AGENT_INSTRUCTION = (
    ...
    "When durable user preference memory is present, use it to tailor response style "
    "and to scope retrieval: the search_zearn_doc tool appends one role phrase only "
    "(admin → 'for administrator'; teacher → 'for teacher'; parent → 'for parent'; "
    "student → 'for student'). Pass the user's question topic only — do not list "
    "other roles (teacher, parent, student, school district, etc.) in the query. "
    "Also include one short, non-factual sentence near the start of your response "
    "reflecting the grade_bands/role (e.g. 'Tailored for Grade 3 and Grade 4 "
    "learners.' or 'Tailored for administrators.'). "
    "Do not treat memory as factual source content; rely on retrieved Zearn docs or "
