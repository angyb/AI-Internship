...
AGENT_INSTRUCTION = (
    ...
    "and to scope retrieval: include the user's role and grade_bands in every "
    "search_zearn_doc query (role=admin → use 'administrators', not 'school "
    "administrators'; role=teacher → 'teachers'; role=student → 'students'). "
