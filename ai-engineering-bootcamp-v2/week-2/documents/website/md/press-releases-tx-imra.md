---
doc_id: press-releases-tx-imra
source_url: https://about.zearn.org/press-releases/tx-imra
title: Zearn Math for Texas Approved by Texas SBOE
source_site: about.zearn.org
source_type: website
language: en
path: /press-releases/tx-imra
section: press-releases
description: Zearn Math for Texas has officially been approved by the Texas State
  Board of Education through the Texas Instructional Materials Review and Approval
  (IMRA) process, earning one of the highest overall Quality scores among K–5 supplemental
  math materials.
scraped_at: '2026-07-23T22:08:30Z'
word_count: 520
...
Texas teacher reviewers found Zearn’s materials demonstrate alignment to the Texas Essential Knowledge and Skills (TEKS) state standards and awarded the program one of the highest average Quality scores (93%) among reviewed materials. Zearn also earned a perfect score for “Balance of Conceptual and Procedural Understanding,” recognizing how every Zearn Math for Texas lesson ensures students build both procedural fluency and conceptual understanding in alignment with the Texas Research-Based Instructional Strategies (RBIS) for math.
...
* 700+ digital lessons across 40 instructional units, following the Bluebonnet Learning scope and sequence to reinforce and deepen classroom instruction.
* Adaptive, real-time support that helps students catch up in moments of struggle while maintaining grade-level rigor.
* Embedded problem solving that blends paper-and-pencil activities to help students strengthen and transfer their learning with STAAR-style digital item types, giving students exposure to the question formats they will encounter on the state assessment.
