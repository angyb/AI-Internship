---
doc_id: math-learning-acceleration-kindergarten
source_url: https://about.zearn.org/math-learning-acceleration/kindergarten
title: Kindergarten Summer Math
source_site: about.zearn.org
source_type: website
language: en
path: /math-learning-acceleration/kindergarten
section: math-learning-acceleration
description: Access free online kindergarten math resources for students and teachers,
  including digital lessons that can be used flexibly across summer math programs.
scraped_at: '2026-07-23T22:08:53Z'
word_count: 587
extraction_method: static
---

# Rising 1st grade math summer series

## Summer math content focused on the big ideas of kindergarten

Our curated series of kindergarten math lessons is designed for students to complete over any 4-to-6-week summer program.

## Number Pairs, Addition and Subtraction to 10

These digital math lessons focus on an exciting new concept for kindergartners—addition and subtraction! Students harness their practiced counting abilities, knowledge of the value of numbers, and work with embedded numbers to reason about and solve addition and subtraction expressions and equations.
