---
doc_id: math-learning-acceleration-grade-1
source_url: https://about.zearn.org/math-learning-acceleration/grade-1
title: First Grade Summer Math
source_site: about.zearn.org
source_type: website
language: en
path: /math-learning-acceleration/grade-1
section: math-learning-acceleration
description: Access free online first grade math resources for students and teachers,
  including targeted digital lessons and paper-based materials that can be used flexibly
  across summer math programs.
scraped_at: '2026-07-23T22:10:13Z'
word_count: 601
extraction_method: static
---

# Rising 2nd grade math summer series

## Summer math content focused on the big ideas of 1st grade

Our curated series of math lessons for 1st graders is designed for students to complete over any 4-to-6-week summer math program.

## Add & Subtract Bigger Numbers

23 Lessons | Grade 1 Mission 4  These 1st grade math lessons focus on counting, composing, and decomposing with large numbers up to 40. Digital lessons are intended to build a strong foundation of flexible strategies for all students to fall back on as they engage with 2nd grade math content and beyond.
