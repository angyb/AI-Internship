---
doc_id: press-releases-utah-state-board-of-education-rating
source_url: https://about.zearn.org/press-releases/utah-state-board-of-education-rating
title: Zearn Math K-5 Receives Highest Level of Rating
source_site: about.zearn.org
source_type: website
language: en
path: /press-releases/utah-state-board-of-education-rating
section: press-releases
description: The Utah State Board of Education (USBE) has recommended Zearn Math for
  all grades K–5 in Utah, labeling it as a "Recommended Primary" curriculum—the highest
  possible distinction.
scraped_at: '2026-07-23T22:07:58Z'
word_count: 418
...
# Zearn Math K-5 receives highest level of rating from Utah State Board of Education

Salt Lake City, UT, January 29, 2020 – The Utah State Board of Education (USBE) has recommended Zearn Math for all grades K–5 in Utah, labeling it as a "Recommended Primary" curriculum—the highest possible distinction. The top rating indicates that Zearn Math aligns with Utah state standards and meets all high-quality indicators, including focus, coherence, rigor, and balance. The USBE also highlights that Zearn Math makes grade-level math accessible to all learners by providing embedded remediation, concrete and pictorial representations, precise feedback, and other supportive features.
